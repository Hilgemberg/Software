...
<html lang="pt-br">
    ...
    <head>
        ...
        <script src="../vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
         ...
         <link rel="shortcut icon" href="../img/Voluntariado_PRIMACERDI_logomarca_final.ico" type="image/x-icon">
    <link rel="icon" href="../img/Voluntariado_PRIMACERDI_logomarca_final.ico" type="image/x-icon">
...
<!--(bg-gradient) BG tem referencia a blagroud (Fundo) -->
                <!-- Sidebar - Brand -->
...
<!-- Divider são as linhas que separam os menus -->
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                           <h6 class="collapse-header">Projeto Voluntários:</h6>   
                            
                            <a class="collapse-item" href="index.php?pag=<?php echo $menu1 ?>">Inscritos</a>

                            <a class="collapse-item" href="index.php?pag=<?php echo $menu2 ?>">Voluntários</a>

                            <a class="collapse-item" href="index.php?pag=<?php echo $menu2 ?>">Programas</a>

                            <a class="collapse-item" href="index.php?pag=<?php echo $menu4 ?>">Projetos</a>
                            
                            <!-- referencia para os menus que estão configurados no inicio, desta maneira não vai --> <!-- carregar uma pagina. -->
                        </div>
                    </div>
                </li>
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                        ...
                        <!-- Abaixo fica o chamado da logo do sistema -->
                        <img class="mt-2" src="../img/Voluntariado_PRIMACERDI_logomarca_final.png" width="70">
                    ...
                    <div class="container-fluid">
                        ...
                        //Referencia aos menus da pagina
                        } else if (@$pag==$menu1) {
                        @include_once(@$menu1.".php");
                        //Concatenando uma referencia ao menu que esta sendo passado com .php
